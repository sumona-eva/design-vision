    ...
    <AppLayout>
        <div class="flex items-center justify-between p-5 bg-white">
            <div>
                <div class="flex items-center">
                    <h2 class="text-xl py-5 px-3 font-semibold text-primary">Project Categories</h2>
                </div>
                <div>
        ...
        <div class="relative overflow-x-auto bg-white">
            <table class="w-full text-left rtl:text-right">
                ...
                <tbody>
                <tr class="border-b border-gray-300 hover:bg-gray-200" v-for="item in categories?.data">
    ...
    <Modal title="Create New Category" :isOpen="isModalOpened" @modal-close="closeModal">
        <div class="flex flex-wrap pt-5">
            ...
            <div class="w-full mb-4">
                ...
                <input v-model="form.order_number" type="number" class="p-2 rounded w-full">
            </div>
            <div class="w-full">
